...
const NavBar = ({ ocultarMenu, estilos, estilosNavList, estilosLi, estilosLiOcultar }) => {
  const estilosNavBarHeaderMovileVisible = 'absolute md:relative -translate-x-4 translate-y-48 md:translate-y-0 md:translate-x-0 w-full md:w-auto transition duration-200';
